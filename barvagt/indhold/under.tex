...
\begin{itemize}
    \item Prisen kan findes i \textit{Zettle}\index{Zettle} appen. Hvis den ikke kan findes heri, så spørg et bestyrelsesmedlem.
...
Der er forskellige slags \textit{pant}\index{Pant}, og de skal sorteres.
\begin{description}
