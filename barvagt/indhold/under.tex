...
\begin{itemize}
    ...
    \begin{itemize}
        \item Husk at tjekke at betalingen bliver godkendt.
...
\begin{quote}
    \emph{Brug gerne samme princip som ved toiletruller: Få fat
...
Den fyldte pose fragtes til pantcontainerne i P-kælderen ved siden af pantkaret og 
lukkes med en strips.

Under barvagten mens der er stille eller ved oprydning, går man en tur rundt i Nygaard 
og tømmer pantkasserne, og sætter nye poser i, hvis de er fuldte.
En oversigt over hvor pantkasserne står, kan findes \href{https://media.fredagscafeen.dk/guides/pantspande.pdf}{her}.

\subsection{Andet}
\label{sec:intra:andet}

\begin{itemize}
    \item Bartendere får ud over aftensmad, også én valgfri øl/cider/RTD for maks. 50 kr.,
    én pose chips, samt \textit{fri} gratis sodavand under deres barvagt.

    \item Vi udlejer diverse brætspil/terninger/spillekort/bordtennisbolde/pool. 
    ...
    \item Det er muligt at afspille musik under barvagten, ved at bruge
    ...
    \item Hvis en kunde overvejer at købe en specialfad eller cider, kan det være en god idé 
    at tilbyde dem en smagsprøve, så de ved, hvad de får. Dette konverterer ofte til et
    salg, men er også med til at give kunderne en god oplevelse.

    \item Husk at tømme bordene undervejs for affald og tomme flasker, så nye
    kunder kan komme til.

    \item Der ringes normalt \textit{sidste omgang}\index{Sidste omgang}
    ...
    \item Kl. 22:00 spilles ``skrub af''-musik og der sælges ikke mere.
\end{itemize}
