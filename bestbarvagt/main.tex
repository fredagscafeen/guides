...
\textit{Barområdet}\index{Barområdet}, så vi kan sælge kolde vare og øl der skummer minimalt, så snart baren åbner.\\
...
\begin{itemize}
    ...
    \item \textit{Hængelåsene}\index{Hængelåsene} omkring køleskabene i Barområdet låses op. 
...
\QnA[akut-situation]{Akut situation}{
    ...
    I tilfælde af brand og ulykker, aktiver varslingsanlæg (brandalarm).
    \item[4.] Ring til AU's alarmeringsnummer 87 15 16 17
    \item[]
    Husk på at du som frivillig, ikke skal kunne klare alle situationer på egen hånd. 
    ...
    I nogle festforeninger og fredagsbarer har man sine egne dørmænd til festen, 
    som kan inddrages i håndteringen af svære situationer. 
    Da vi ikke har dørmænd (fordi vi ikke har haft brug for det), 
    kan det være nødvendigt enten at tilkalde politiet eller AU's vagtselskab, \textit{Securitas}\index{Securitas}. 
