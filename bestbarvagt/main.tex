...
\begin{itemize}
    ...
    \textit{Pengekassen}\index{Pengekassen} før eller efter baren er sat op, men den må bare aldrig stå uden opsyn!
\end{itemize}
...
\begin{itemize}
    ...
    \item Baren vores hjertebarn, hjem til de gyldne dråber. 
    ...
    \begin{itemize}
        ...
        Hvis der nu også er vand i den her slang, skal der også køres vand igennem her. 
        ...
        Husk at tømme og skylle \textit{drypspanden}\index{drypspand} du har brugt og tag en med ud. 
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    Kontanter, kvitteringer og Krydslisten lægges i \textit{deponeringsboksen}\index{deponeringsboksen} i Rummet ved
