...
\date{\formatdate{16}{2}{2026} \& Redigeret \formatdate{25}{5}{2026}}
...
\textbf{BEMÆRK:} Der findes en amerikansk kobling der ligner S-koblingen næsten på en prik, men som er lidt bredere i bunden. Denne hedder en D-kobling, og den er ikke kompatibel med S-koblingen.
...
\section{STRØM}
Vi har fået installeret industielt strømstik I baren, med eget relæ der har automatsikringer, som blot skal tændes igen, hvis en sikring går. 

Vær opmærksom på, at der ikke må ligge kabler/skinner henover gulvet mellem søjlen og kæleskabene, når baren ikke er åben. Disse skal derfor fjernes ved luk!

Er strømmen gået, og det ikke er på vores relæ, skal man ud i teknikrummet lokale 5335-K71B ved elevator/toiletter i Nygaard-kælderen og skifte en sikring. Disse ligger i en kasse, og de sprungne sikringer vil lyse, når de sprænger. Her skal drift kontaktes, før det kan fikses!
\begin{figure*}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{PowerSetup.jpg}
    \caption{Strøm-relæet i baren, med sikringer bagved. Disse skal bruges i baren, til så meget som muligt. Stik med label $1$ og $4$ er samme gruppe, så brug dem så lidt som muligt sammen!}
\end{figure*}
\begin{figure*}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{Teknikrum.jpg}
    \caption{Vores sikringer i teknikrummet lokale 5335-K71B.}
\end{figure*}
