...
\date{\formatdate{2}{2}{2021}. Redigeret \formatdate{25}{5}{2026}}
...
\begin{itemize}
\item 5 Extra Pilsner (EP) \emph{(Lageransvarlig har ansvar)}
\item 1 - 2 Sæsonøl \emph{(Lageransvarlig har som udgangspunkt ansvar)}
\item 1 - 2 Specialøl \emph{(Specialølsansvarlig har som udgangspunkt ansvar)}
\item 1 - 2 Cider \emph{(Specialølsansvarlig har som udgangspunkt ansvar)}
...
at man skal have et lager på omkring 10 - 20 fustager øl. Dette kommer an på mængden aftalt med eventansvarlige. Man kan følgende uge lave en modsvarende mindre bestilling. Man behøver ikke at bestille øl, man kan også bestille en tømning af tomme fustager.
...
\href{mailto:nfb@aarhusbryghus.dk}{nfb@aarhusbryghus.dk}. Dette må meget gerne gøres senest tirsdag i den uge man har brug for bestillingen.
...
\section{Sortiment og priser}
Det er altid bedst at spørge Christopher om sortiment, da han ved hvad der er af gode nyheder på Bryghuset.

Vi har også fået adgang til et Google Sheets overblik, som ikke altid er op til dato, men hvor vi kan se hvad vi kan få af fadøl og dåser hos Aarhus Bryghus. Vi får 4 kr/liter før moms i yderst venlig studiebar-rabat hos dem på fustager, ift. de priser man ser derinde. Ingen rabat på dåser.

\href{https://docs.google.com/spreadsheets/d/1woU3ttgaFa108hYzXOAtH7SKW-YQArFpZrfmMY5OPss/edit?usp=sharing}{Google Sheets overblik}
